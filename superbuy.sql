...
CREATE TABLE `notificaciones` (
  ...
  UNIQUE KEY `id_notificaciones_UNIQUE` (`id_notificaciones`)
...
CREATE TABLE `productos` (
  ...
  KEY `producto_categoria` (`id_usuario`),
  CONSTRAINT `producto_categoria` FOREIGN KEY (`id_usuario`) REFERENCES `categorias` (`id_categoria`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8;
